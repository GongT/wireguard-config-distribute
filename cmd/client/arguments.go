...
type clientProgramOptions struct {
	...
	NetworkName string `short:"n" long:"netgroup" description:"a (friendly) name of local network, all machines in one local network should same" required:"true" env:"WIREGUARD_NETWORK"`
